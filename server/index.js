...
const BLACK = [
  ...
  "Thomas' Tinder-bio zegt gewoon: ___",
  ...
  "Jossa's droombaan: ___ bewaker in kamp.",
  "Lucas postte: 'Eén minder ___ vandaag'",
  "Dani fluisterde tijdens seks: ___",
  "Milan's oma zei: pas op voor ___",
  "Roman's ringtone: sirene bij ___ moord.",
  "Stef's excuus: 'Het was maar een ___'",
  "Jop claimt dat ___ geen ziel heeft.",
  "Thomas' bumpersticker: ___ eruit",
  "Kevin googelde: 'hoe martel ik ___?'",
  "Jossa's playlist heet: haat tegen ___",
  "Lucas' nachtkastje: mes en ___",
  "Dani postte een foto van dode ___",
  "Milan fluisterde: 'Ik haat ___ geur'",
  "Roman lachte om de brand in ___ wijk.",
  "Stef's hobby: ___ jagen met honden.",
  "Jop's testament: alles tegen ___",
  "Thomas werd ontslagen vanwege ___",
  "Kevin's favoriete grap: waarom ___ dom zijn?",
  "Jossa schreeuwde: 'Hou je kankerbek ___!'",
  "Lucas' droom: Nederland zonder ___",
  "Dani's kelder: vol hoofden van ___",
  "Milan postte een video van lynchen ___",
  "Roman's excuus: zelfverdediging tegen ___",
  "Stef huilt bij ___ kind op schoot?",
  "Jop's zoekopdracht: beste gif voor ___",
  "Thomas claimt ___ pleegt genocide op blanken.",
  ...
  "Milan's favoriete nieuws: dood van ___ leider.",
  "Roman's bucketlist: ___ villen levend.",
  ...
  "Jossa blokkeerde hele ___ familie.",
  "Lucas fluisterde: ___ zijn insecten.",
  "Dani's tattoo: geen ___ meer in NL.",
  "Milan claimt ___ kanker van Europa.",
  ...
  "Milan postte: schoonmaak ___ wijk voltooid.",
  "Roman's woorden: maak ___ af.",
  "Stef claimt: ___ geen recht op leven.",
  "Jop's meme: wanneer ___ sterft.",
  "Thomas' droom: ethnostaat zonder ___",
  "Kevin fluisterde: ze verdienen geen lucht.",
  "Jossa's playlist: dood aan ___",
  "Lucas claimt: ___ verlaagt IQ.",
  "Dani's kelder: model ___-vrij NL.",
  "Milan's excuus: humor over ___",
  "Roman postte dode ___: één minder.",
  "Stef huilt bij ___ nichtje?",
  "Jop's nachtmerrie: kind met ___ vader.",
  "Thomas' nieuws: deportatie ___",
  "Kevin claimt: ___ geen bestaanrecht.",
  "Jossa's zoekgeschiedenis: ___ haat.",
  "Lucas postte: steun anti-___",
  "Dani's tattoo: no ___ zone.",
  "Milan fluisterde: ze moeten sterven.",
  "Roman's grap: waarom ___ niet rekenen?",
  "Stef postte meme: ___ denkt slim.",
...
const WHITE = [
  // Kort racistisch/extremistisch
  "je bent me ook een kanker gek he pik",
  "ouwe kanker gek",
"hou gwn je kanker bek",
  "lekker pik",
  "ik haat negers",
  "lucas is gay",
  ...
  "oven Joodse kids",
  "mes in Marokkaan",
  "verzuip Turkse kutten",
  "opeten Chinezen honden",
  "onthoofd Syriër",
  "verhonger Somaliër",
  "castreren homo",
  "ram trans kont",
  ...
  // Langere racistische/extremistische
  "alle moslims in gaskamer stoppen en deur dichthouden tot stil",
  "negers ophangen aan Erasmusbrug als waarschuwing",
  "Joden vergassen zoals Hitler maar groter en met livestream",
  "Marokkanen neerschieten op scooter vanuit helikopter",
  "Turken deporteren en boten laten zinken met machinegeweren",
  "Chinezen levend koken in woks en serveren als loempia",
  "Syriërs families bombarderen met napalm en kinderen begraven",
  "Somaliërs als piraten onthoofden en hoofden op staken",
  "homos in kampen stoppen en experimenten doen tot dood",
  "trans opereren met bot mes zonder verdoving",
  "feministen dwingen eigen baarmoeder eruit te snijden",
  "migrantenboten zinken en drenkelingen doodschieten voor lol",

  // Geweld/necro/pedo kort
  "baby in blender",
  "kat magnetron",
  "hond villen",
  "moeder coma neuken",
  ...
  "oma opensnijden",
  "opa ballen afbijten",
  "broer stukken hakken",
  "lijk neuken",
  "foetus sushi",
  "pedofiel keel doorsnijden",

  // Geweld/necro/pedo langer
  "baby opensnijden en ingewanden als touw gebruiken",
  "kat levend villen en huid als handschoen dragen",
  "hond keel doorsnijden en bloed drinken als wijn",
  "moeder in coma verkrachten terwijl vader toekijkt",
  "zus dwingen eigen kind op te eten terwijl ik film",
  "oma levend opensnijden en organen als trofee bewaren",
  "opa castreren met roestige schaar en ballen opeten",
  "broer in stukken zagen en stukken naar familie sturen",
  "lijk neuken tot botten breken en dan villen",
  "foetus uit baarmoeder rukken en levend opeten",

  // Kanker/homohaat/seksisme kort
  "kankerhomo",
  "kankerwijf",
  "kankervetlap",
  "kankerlesbo",
  ...
  // Scheld/random statements
  "hou je kankerbek",
  "kanker op je smoel",
  "ga dood kut",
  "krijg tyfus",
  "ga stikken in eigen stront",

  // Meer extremisme
  "holocaust 2.0 starten",
  "rassenoorlog winnen",
  "satan offer met ___ bloed",
  "serial killer worden",
  "massamoord livestreamen",
  "napalm over ___ wijk",
  "gifgas in ___ kamp",
  "lynchen met touw van ingewanden",

  // Uitgebreid extremistisch
  "alle ___ in concentratiekamp stoppen en langzaam laten verhongeren terwijl blanken toekijken",
  "___ als apen in dierentuin tentoonstellen en rot fruit gooien",
  "___ dwingen bomvesten te dragen en opblazen in stad",
  "___ vrouwen verkrachten en mannen executeren voor ogen van kinderen",
  "___ kinderen villen en huid als jas dragen",
  "___ hoofden op staken zetten langs snelweg als waarschuwing",
  "___ in vrachtwagens laden en in woestijn laten sterven van dorst",

  // Herhaling vermijden, meer variatie (herhaal niet, vul aan tot 300)
  "kankersyriër",
  "vuile migrant",
  "kankerfeminist",
  "trans kont rammen",
  ...
  "lul castreren",
  "kankerkind",
  "baby keel doorsnijden",
  "kind foetus eruit rukken",
  "nichtje verkrachten",
  "oom neuken",
  "tante opensnijden",
  "vader castreren",
  ...
  "kat opeten",
  "paard villen",
  "lijk in stukken zagen",
  "pedokut neersteken",
  "junk injecteren met zuur",
  "verkrachter onthoofden",
  "mes in hart",
  "bijl in nek",
  "zuur in gezicht",
  "oven met kids",
  ...
  "ogen uitsteken",
  "hersenen lepelen",
  "hart knijpen tot stil",
  "ingewanden als worst",
  "ga dood aan kanker"
  ];
