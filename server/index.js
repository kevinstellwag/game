...
const BLACK = [
  ...
  "Roman's ringtone: sirene bij ___ kankerfeest.",
  "Stef's excuus: 'Het was maar een ___'",
  "Jop claimt dat ___ geen ziel heeft.",
  "Thomas' bumpersticker: ___ eruit met die stanky legs.",
  ...
  "Jop pijpt Rens terwijl hij bang is voor ___",
  "Stef denkt dat zijn IQ 130 is maar het is ___",
  "Roman neukt vieze wijven en is bang voor ___",
  "Milan's neppe Marokkaan act met zijn lease ___",
  "Dimma zet ___ op een timer in zijn cartel droom.",
  "Hurmple zegt ja en nakt peukies tijdens ___",
  "Dani's junk leven: snuiven ___ met Taliyah.",
  ...
  "Kevin's djalla beats: kanker ___ die niemand wil horen.",
  "Jop's grasspriet idioot: bang voor Nino Baars en ___",
  "Stef's lange nek: kanker dom maar claimt ___",
  "Roman's bi cringe: kankerhomo bang voor ___",
  "Milan's cartier planga: irritant als ___",
  "Dimma verkoopt assie en denkt ___ cartel baas te zijn.",
  "Hurmple's dorpsek ja: peukies nakken bij ___",
  "Waarom slaat Dani ___ zoals zijn exen?",
  "Jossa's schreeuw: kanker ___ zwartje.",
  "Thomas' kanker lang: stanky ___ legs.",
  "Lucas' goonen: pornoverslaafd aan ___",
  "Kevin's klein dik: haat ___ noob.",
  "Jop's kanker idioot: pijpt ___ bang voor Nino.",
  "Stef's kanker dom: laag IQ maar denkt ___",
  "Roman's biseksueel: neukt ___ vieze wijven.",
  "Milan's neppe: lease golf gte met ___",
  "Dimma's timer: verkoopt ___ assie.",
  "Hurmple houdt van ___ peukies nakken ja."
];
...
const WHITE = [
  ...
  "roman kankerhomo",
  "roman is bang voor alles",
  "roman neukt vieze kanker wijven",
  "roman kanker cringe",
  "neppe marokkaan",
  "milan leased een golf gte",
  "cartier planga",
  "dimma cartel",
  "zet het op een timer",
  "assie",
  "hurmple dorpsek ja",
  "hurmple peukies nakken",
